        ...
        <div className='lg:w-[50%] my-auto text-center'>
          ...
          <nav className='mx-auto w-full sm:w-max flex flex-col sm:flex-row gap-4 sm:gap-8'>
            ...
            <button
              ...
              className="text-gray-800 bg-white hover:bg-gray-50 border border-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-8 py-3"
              onClick={() => {
