    ...
    <>
      ...
      <section className="grid grid-cols-2 gap-8 py-16" style={{ height: `calc(100vh - ${headerHeight || 0}px)` }}>
        ...
        <div className="flex flex-col gap-8 items-start">
          ...
          <a target='_blank' href={project.link} type="button" className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-8 py-3 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
            Visit the Project
          </a>
        </div>
      </section>
